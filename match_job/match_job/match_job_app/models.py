...
class EmployeeLanguage(models.Model):
    language_name = models.CharField(max_length=50,choices=LANGUAGE_CHOICES,default='Polski')
    level = models.CharField(max_length=50,choices=LANGUAGE_LEVEL_CHOICES,default='MASTER')
...
class EmployeeJobTarget(models.Model):
    ...
    target_user = models.ForeignKey(Employee,on_delete=models.CASCADE,related_name='target',null=True)
